...
/**
 * AdminTextWrite 클래스 - 관리자 전용 글 작성 기능을 제공하는 클래스입니다.
 */
public class AdminTextWrite extends Db {

	/**
	 * 관리자 전용 글 작성 실행 메서드
	 */
	public static void AdminTextWriteRun() {
		// 사용자에게 글 작성 주의사항 안내
		Cw.wn("===========================");
		Cw.wn("공지사항 작성");
		Cw.wn("작성시 주의사항");
		...
		textWrite: while (true) {
			...
			case "y":
				Db.dbHub("Other", "Insert into adminBoard(a_title, a_datetime, a_hit, a_text) value ('" + textTitle
						+ "', now(), 0, '" + textBody + "')");
